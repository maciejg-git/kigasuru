export default function Switch({ value, onClickSwitch, className, ...props }) {
  return (
    ...
    >
      ...
      <div className="group-has-checked:bg-violet-400 group-has-focus:ring-4 dark:group-has-checked:bg-gray-500 relative flex h-6 w-11 items-center rounded-full bg-neutral-200 px-0.5 ring-violet-200 dark:bg-neutral-800">
